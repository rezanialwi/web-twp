...
<section class="box-formulir bg">
	<div id="pendaftar" class="container-fluid pendaftar">
			<div class="container daftar">
				<h3 class="text-center pertama">Absensi Calon Anggota Teater Wasi Putih</h3>
				
				<div class="row">
					<div class="col-md-6 offset-md-3">
			 <form class="user" action="<?php echo base_url(). 'absen_c/tambah_aksi'; ?>" method="post">
            ...
            <br>
                  <a href="<?php echo site_url('user/home') ?>" role="button"  class="btn btn-warning col-md-12 mb-3">Kembali</a>
