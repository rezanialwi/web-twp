...
<body id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tambah Data Absensi Calang</h6>
            </div>
				 <form class="user" action="<?php echo base_url(). 'absen_calang/tambah_aksi'; ?>" method="post">
               <div class="form-group">
               <label for="alamat"> Nama Anda :</label>
                  <input type="text" class="form-control form-control-user" name="nama_calang" placeholder="Nama Anda">
                </div>
               <div class="form-group">
