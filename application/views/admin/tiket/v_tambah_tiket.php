        ...
        <div class="container-fluid">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tambah Data Tiket</h6>
				 ...
				 <form class="user" action="<?php echo base_url(). 'tiket_admin/tambah_aksi'; ?>" method="post">
               ...
               <div class="form-group">
               <label>Asal Kampus/organisasi : </label>
                  <input type="text" class="form-control form-control-user" name="asal" placeholder="Asal Kampus/Organisasi Anda">
                </div>
                <div class="form-group">
                <label>No.Telp/Wa : </label>
                  <input type="number" class="form-control form-control-user" name="telp" placeholder="Telp/Wa Anda">
                </div>
                <div class="form-group">
                <label>Email : </label>
