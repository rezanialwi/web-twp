...
<body id="page-top">
  ...
  <a href="<?php echo site_url('tiket_admin/') ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm">
  <i class="fas fa-reply fa-sm text-white-50"></i>Kembali</a>
                  </div>
                  </div>
                  <?php echo form_close() ?>
	 <div class="card-body">
