...
<body id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Edit Data Absen Calang</h6>
			</div>
			<?php foreach($absensi_calang as $u){ ?>
				 <form class="user" action="<?php echo base_url(). 'absen_calang/update'; ?>" method="post">
               ...
               <label for="alamat"> Nama Anda :</label>
                  <input type="text" class="form-control form-control-user" name="nama_calang"value="<?php echo $u->nama_calang ?>">
                </div>
                <div class="form-group">
                  	<div class="col-sm-15">
                <?php
      ...
      <br>
		 <?php echo anchor('absen_calang/index','<button class="btn btn-danger btn-user btn-block">Kembali</button>'); ?>
					<?php } ?>
  </div>
