        ...
        <div class="container-fluid">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tambah Data Proker</h6>
				 ...
				 <form class="user" action="<?php echo base_url(). 'proker/tambah_aksi'; ?>" method="post">
               <div class="form-group">
                  <input type="text" class="form-control form-control-user" name="nama_proker" placeholder="Nama Proker/Acara">
                </div>
                <div class="form-group">
                  <input type="date" class="form-control form-control-user" name="tanggal" placeholder="Tanggal Pelaksanaan">
                </div>
