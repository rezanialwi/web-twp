...
<body id="page-top">
	 ...
	 <div class="card-body">
       <a href="<?php echo site_url('pengurus/create') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
    <i class="fas fa-plus fa-sm text-white-50"></i>Tambah Data</a>
  <a href="<?php echo site_url('pengurus/cetak') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
     ...
     <table class="table table-bordered" width="100%" cellspacing="0">
      ...
      <input type="hidden" name="id_pengurus" value="<?php echo $data->id_pengurus?>">
			...
			<td>
			     ...
			     <?php echo anchor('pengurus/edit/'.$data->id_pengurus,'<button class="btn" > 
                    <i class="fa fa-mouse-pointer"></i>'); ?>
                 <?php echo anchor('pengurus/delete/'.$data->id_pengurus,'<button class="btn  ">
                    <i class="fas fa-trash"></i>'); ?>
                    
                    <?php echo anchor('pengurus/cetak_id/'.$data->id_pengurus,'<button class="btn " >
